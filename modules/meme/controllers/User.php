...
class User extends AdminController {  
	...
	function save(){
		...
		$site_id = $this->input->post('user_site_id');
		$data = array(
			...
			'user_providerid'		=> $this->input->post('user_providerid'),
		...
		if(isset($_POST['user_group']) && strlen($_POST['user_group']) > 0){
		...
		$msg = !empty($img) ? 'Save data User success' : '';
