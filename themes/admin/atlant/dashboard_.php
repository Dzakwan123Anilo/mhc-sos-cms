	    	...
	    	<div class="row">
				...
				<div class="col-md-6">
            		...
            		<div class="row">       
						...
						<div class="col-md-5">       
							<input type="text" id="actmember_my" name="actmember_my" class="form-control" placeholder="month-year" onchange="getActiveMember($('#actmember_clientid').val(),$(this).val())"/>
	            			<!--<div class="row">       
								<div class="col-md-7">
	    	...
	    	<div class="row">
				<div class="col-md-6">
            		...
            		<div class="row">     
						<div class="col-md-2 control-label">Client Name</div>
						<div class="col-md-4">
							<select class="form-control select" name="swipeclient_clientid" id="swipeclient_clientid" onchange="getSwipeByClient($(this).val(),$('#swipeclient_my').val())">
								<option value="">- all -</option>
							<?php 
								echo option_client('');
							?>
						...
						<div class="col-md-1 control-label">Period</div>
						<div class="col-md-5">
							<input type="text" id="swipeclient_my" name="swipeclient_my" class="form-control" placeholder="month-year" onchange="getActiveMember($('#actmember_clientid').val(),$(this).val())"/>
	            			<!--<div class="row">       
								<div class="col-md-7">
				...
				<div class="col-md-6">
            		...
            		<div class="row">       
						<div class="col-md-2 control-label">Client Name</div>
						<div class="col-md-4">
							<select class="form-control select" name="swipemore_clientid" id="swipemore_clientid" onchange="getSwipeMore($(this).val(),$('#swipemore_my').val())">
								<option value="">- all -</option>
							<?php 
								echo option_client('');
							?>
						...
						<div class="col-md-1 control-label">Period</div>
						<div class="col-md-5"> 
							<input type="text" id="swipemore_my" name="swipemore_my" class="form-control" placeholder="month-year" onchange="getActiveMember($('#actmember_clientid').val(),$(this).val())"/>      
	            			<!--<div class="row">       
								<div class="col-md-7">
	    	...
	    	<div class="row">
				<div class="col-md-6">
            		...
            		<div class="row">       
						...
						<div class="col-md-4">
							<select class="form-control select" name="swipeprovider_providerid" id="swipeprovider_providerid" onchange="getSwipeByProvider($(this).val(),$('#swipeprovider_my').val())">
								<option value="">- all -</option>
							<?php 
						...
						<div class="col-md-1 control-label">Period</div>
						<div class="col-md-5">       
							<input type="text" id="swipeprovider_my" name="swipeprovider_my" class="form-control" placeholder="month-year" onchange="getActiveMember($('#actmember_clientid').val(),$(this).val())"/>
	            			<!--<div class="row">       
								<div class="col-md-7">
...
$(document).ready(function(){
	...
	getActiveMember('','<?php echo date('n-Y')?>');
	getSwipeByClient('','<?php echo date('n-Y')?>');
	getSwipeByProvider('','<?php echo date('n-Y')?>');
	getSwipeMore('','<?php echo date('n-Y')?>');
	getUserLoginByProvider('');
}); 

function getActiveMember(clientid,period) {
    $('#dash_two tbody').html('<tr><td colspan="6" style="text-align: center">loading...</td></tr>');
	$.post(AJAX_URL+"/get_active_member",{clientid:clientid,period:period},function(o){
		$('#dash_two tbody').html(o);
	});
}
function getSwipeByClient(clientid,period) {
    $('#dash_three tbody').html('<tr><td colspan="8" style="text-align: center">loading...</td></tr>');
	$.post(AJAX_URL+"/get_swipe_by_client",{clientid:clientid,period:period},function(o){
		$('#dash_three tbody').html(o);
	});
}
function getSwipeMore(clientid,period) {
    $('#dash_five tbody').html('<tr><td colspan="8" style="text-align: center">loading...</td></tr>');
	$.post(AJAX_URL+"/get_swipe_more",{clientid:clientid,period:period},function(o){
		$('#dash_five tbody').empty().html(o);
	});
}
function getSwipeByProvider(providerid,period) {
    $('#dash_four tbody').html('<tr><td colspan="8" style="text-align: center">loading...</td></tr>');
	$.post(AJAX_URL+"/get_swipe_by_provider",{providerid:providerid,period:period},function(o){
