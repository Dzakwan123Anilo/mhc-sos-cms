...
<div class="panel panel-default tabs">                            
	<ul class="nav nav-tabs" role="tablist">
	    <li id="li-first"><a href="#tab-first" role="tab" data-toggle="tab">Verifikasi Data Member</a></li>
	    <li id="li-second" class="active"><a href="#tab-second" role="tab" data-toggle="tab">Dashboard Reporting</a></li>
	    ...
	    <div class="tab-pane active" id="tab-second">
	    	<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="panel-body panel-body-table" style="height: 100px; overflow-y: scroll;">			
				        <div class="table-responsive">
				               ...
				               <tbody>
				                ...
				                ?>
				                        <tr>
				                            ...
				                            <td nowrap="nowrap"><?php echo substr($r->showit,1);?></td>
				                            <td><?php echo $r->inpatient;?></td>
				                            <td><?php echo $r->outpatient;?></td>
				                            <td><?php echo $r->dental;?></td>
				                            <td><?php echo $r->emergency;?></td>
