...
<div class="row">
    <div class="col-md-9">
    	<div class="panel" style="height:260px;padding:10px;" id="cart_line_anggota">
    ...
    <div class="col-md-3">
        ...
        <div class="widget widget-success widget-no-subtitle">
            <div class="widget-big-int"><span class="num-count"><?php //echo myNum(get_total_kta());?></span></div>                            
            <div class="widget-subtitle">Total Artikel</div>
            <div class="widget-controls">
                <a href="#" class="widget-control-left"><span class="fa fa-users"></span></a>
            </div>                            
        </div> 

         <div class="widget widget-warning widget-no-subtitle">
            <div class="widget-big-int"><span class="num-count"><?php //echo myNum(get_total_kta(0));?></span></div>                            
            <div class="widget-subtitle">Total KTA Pending</div>
            <div class="widget-controls">
                <a href="#" class="widget-control-left"><span class="fa fa-users"></span></a>
            </div>                            
        </div>                        
