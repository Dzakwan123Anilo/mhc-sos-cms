...
<div class="panel panel-default tabs">                            
	...
	<div class="panel-body tab-content">
	    <div class="tab-pane active">
	  		<div class="well">
				<form id="form-show" action="<?php echo site_url('meme/me');?>" class="form-horizontal" method="post" autocomplete="off"> 
					<div class="row">         
	          			<div class="col-md-12">   
...
<!--	          				</?php }else{ ?>
		...
		<?php if(isset($val)) {?>	
	        ...
	        <div class="row" id="form_verify">
	        	<div class="well">
					<form id="form-validated" action="<?php echo site_url('meme/me');?>/save_claim" class="form-horizontal" method="post">
						...
						<div class="row form-group">       
							...
							<div class="col-md-4">
								...
								<?php 
									echo option_servicetype('',$val->client_id);
								?>
								</select>
							</div>
							<div class="col-md-2">
...
$(document).ready(function(){
	...
	$('#btn_claim').click(function(){
		...
		window.open("<?php echo site_url('meme/me')."/print_preview3/";?>?save=1&pid="+planid+"&mid="+memberid+"&cid="+clientid+"&rt="+relationtype+"&dk="+desc_klaim+"&dt="+tgl_klaim+"&rc="+roomclass+"&st="+servicetype, "Print Preview", "width=400,height=600,left="+((w-400)/2)+",top="+((h-650)/2));
	});
}); 
...
function pdf_preview(filename) {
	...
	window.open("<?php echo site_url('meme/me')."/pdf_preview/";?>?fl="+filename, "PDF Preview", "width=600,height=650,left="+((w-600)/2)+",top="+((h-700)/2));
}
function re_print(idx){
	...
	win = window.open("<?php echo site_url('meme/me')."/print_preview/";?>?save=0&pid="+planid+"&dt="+date+"&mid="+memberid+"&cid="+clientid+"&rt="+relationtype+"&rc="+roomclass+"&st="+servicetype, "Print Preview", "width=400,height=600,left="+((w-400)/2)+",top="+((h-650)/2));
}
