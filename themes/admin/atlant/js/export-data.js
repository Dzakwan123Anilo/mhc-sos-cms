EXPORT_DATA = {
    init: function(){
		...
		$("#actmember_my_from,#actmember_my_to,#swipeclient_my_from,#swipeclient_my_to,#swipemore_my_from,#swipemore_my_to,#swipeprovider_my_from,#swipeprovider_my_to").datepicker( {
		    format: "m-yyyy",
		    startView: "months", 
		    minViewMode: "months",
        autoclose: true,
