	            ...
	            <table class="table table-hover table-bordered table-striped">
	               ...
	               <tbody>
	                <?php if( count($data) > 0 ){                      	
	                        ...
	                        <tr>
	                            <td><?php echo ++$no;?></td>
	                            <td><?php echo $r->client_code?></td>
	                            <td><?php echo $r->client_name?></td>
	                            <td><?php echo $r->client_address?></td>
	                            <td><?php echo $r->client_phone?></td>
	                            <td><?php echo $r->client_email?></td>
	                            <td><?php echo $r->client_region?></td>
	                            <td><?php echo $r->client_location?></td>
	                            <td><?php echo $r->client_description?></td>
	                            <td><?php echo $r->client_status==1?'<span class="label label-info">Tampil</span>':'<span class="label label-warning">Tidak Tampil</span>';?></td>
	                            <td><?php link_action($links_table_item,"?_id="._encrypt($r->client_id));?></td>
	                        </tr>
	                <?php } 
	                	}?>
	                </tbody>
