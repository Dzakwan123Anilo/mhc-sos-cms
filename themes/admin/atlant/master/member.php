			...
			<div class="panel panel-default" style="margin-top:-10px;">
			    <div class="panel-heading">
			        ...
			        <ul class="panel-controls" style="margin-top: 2px;">
			            ...
			            <li><a href="#" id="export_member_xls"><span class="fa fa-download"></span></a></li>                                     
			        </ul>           
			    </div>
			    <div class="panel-body panel-body-table">
					
			        <div class="table-responsive">
			            <table class="table table-hover table-bordered table-striped" id="membertable">
			               <thead>
			                <tr>
			                    <th width="30px">No</th>
			                    <th>Client</th>
			               ...
			               <tbody> 
			                <?php $no=0;
			                	if( count($data) > 0 ){
				                    ...
				                    foreach($data as $r){ 
			                ?> 
			                        <tr id="<?php echo _encrypt($r->member_id);?>" style="cursor: pointer;" onclick="JS_MEMBER._showData(<?php echo $r->member_id;?>);">
			                            <td><?php echo ++$no;?></td>
			                            ...
			                            <td><?php echo $r->member_plantype=='PLAN_FE'?'':$r->member_dentallimit;?></td>
			                        </tr>
			                <?php } } ?>
			                </tbody>
			            </table>
...
var URL_EXPORT_DATA = '<?php echo $own_links;?>/export_data';
var URL_GET_DATA_MEMBER = '<?php echo $own_links;?>/get_info_member';
function page(pg) {
	$('#page').val(pg);
