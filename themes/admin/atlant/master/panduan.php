	                ...
	                <?php if( count($data) > 0 ){
	                    foreach($data as $r){ ?>
	                        <tr>
	                            ...
	                            <td><?php echo $r->panduan_description?></td>
	                            <td><a href="javascript:void(0)" onclick="pdf_preview('<?php echo _encrypt($r->panduan_filename);?>')"><?php echo $r->panduan_filename?></a></td>
	                            <td><?php echo $r->panduan_status==1?'<span class="label label-info">Tampil</span>':'<span class="label label-warning">Tidak Tampil</span>';?></td>
	                            <td><?php link_action($links_table_item,"?_id="._encrypt($r->panduan_id));?></td>
	                        </tr>
	                <?php } } ?>
	                </tbody>
	            </table>
