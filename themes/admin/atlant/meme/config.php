        ...
        <div class="row form-group">  
            ...
            <div class="col-md-5">
              <?php
                ...
                }elseif($v->config_obj == 'tagsinput'){
                  echo "<input type='text' class='validate[required] form-control tagsinput' $v->config_obj_attr id='$v->config_name' name='$v->config_name' value='$v->config_value' />";
                }else{
