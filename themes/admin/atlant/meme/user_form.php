...
<form id="form-validated" enctype="multipart/form-data" action="<?php echo $own_links;?>/save" class="form-horizontal" method="post"> 
        ...
        <div class="row">
          <div class="col-md-5">
            ...
            <div class="row form-group">
              ...
              <div class="col-md-7">
                  ...
                  <?php } ?>
                  <span class="help-block">Max 500kb (1024x768)px </span>
              </div> 
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="row form-group">  
              <div class="col-md-5 control-label">Domain</div>
              <?php if($this->jCfg['user']['is_all']){?>
              <div class="col-md-7">
                  <select class="validate[required] form-control" name="user_site_id" id="user_site_id">
                      <option value="">- pilih domain - </option>
                      <?php 
                        $dom = isset($val)?$val->user_site_id:'';
              ...
              <div class="col-md-7 control-label" style="text-align:left;">
                <?php echo $this->jCfg['user']['domain'];?>
              </div>
              <?php } ?>
            </div>
            ...
            <div class="row form-group">
              ...
              <div class="col-md-7" style="margin-left:0px;">
                  ...
                  <select name="user_group" class="form-control validate[required]" id="user_group">
            ...
            <div class="row form-group">
              <div class="col-md-5 control-label">Provider</div>
              <div class="col-md-7" style="margin-left:0px;">

                  <select name="user_providerid" class="form-control select" id="user_providerid">
                    <option value=""> - pilih -</option>
                  <?php 
                  	$pro = isset($val)?$val->user_providerid:'';
                    echo option_provider($pro);
                  ?>
                  </select>
