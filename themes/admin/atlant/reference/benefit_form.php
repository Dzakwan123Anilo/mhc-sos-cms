        ...
        <div class="row">
          <div class="col-md-9">
            ...
            <div class="row form-group">  
              ...
              <div class="col-md-9">
                  <select class="validate[required] form-control select" name="benefit_clientid" id="benefit_clientid">
                      <option value=""> - pilih client - </option>
                      <?php 
                        $cli = isset($val)?$val->benefit_clientid:'';
...
var GET_PLANT_TYPE = '<?php echo $own_links;?>/get_plant_type';
var CID = '<?php echo $cli;?>';
var STID = '<?php echo $serv;?>';
var PTID = '<?php echo $plan;?>';
</script>