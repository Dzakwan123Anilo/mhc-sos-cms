	                ...
	                <?php if( count($data) > 0 ){             	
	                    ...
	                    foreach($data as $r){ ?>
	                        <tr>
	                            ...
	                            <td><?php echo $r->propinsi_status==1?'<span class="label label-info">Tampil</span>':'<span class="label label-warning">Tidak Tampil</span>';?></td>
	                            <td><?php link_action($links_table_item,"?_id="._encrypt($r->propinsi_id));?></td>
	                        </tr>
	                <?php } } ?>
	                </tbody>
	            </table>
